...
class ProductForm(forms.ModelForm):
    class Meta:
        model = HennaProduct
        fields = ['sku', 'name', 'category', 'price', 'rating', 'stock_quantity', 'is_available', 'description', 'image', 'image_url']
        widgets = {
...
class DiscountForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'value': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Discount Value'}),
